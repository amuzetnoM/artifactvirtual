...
import { A as AstroError, G as UnknownContentCollectionError, a as createComponent, H as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, J as renderUniqueStylesheet, K as renderScriptElement, O as createHeadAndContent, r as renderComponent, f as AstroUserError } from './astro/server_C6oLnoy8.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BnV77WQH.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://amuzetnoM.github.io/artifactvirtual", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_Ce3kEGlt.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_paerTZ_J.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DA-yEn_0.mjs');
...
const starlightConfig = {"social":[{"icon":"github","label":"GitHub","href":"https://github.com/amuzetnoM/artifactvirtual"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Journal","translations":{},"collapsed":false,"items":[{"label":"A1W18D1","translations":{},"slug":"journal/A1W18D1","attrs":{}}]},{"label":"Manifesto","translations":{},"collapsed":false,"items":[{"label":"Preface","translations":{},"slug":"manifesto/_preface","attrs":{}},{"label":"Principles","translations":{},"slug":"manifesto/_index","attrs":{}},{"label":"Singularity I","translations":{},"slug":"manifesto/singularity_1","attrs":{}},{"label":"Regeneration","translations":{},"slug":"manifesto/regeneration","attrs":{}},{"label":"Commands","translations":{},"slug":"manifesto/commands","attrs":{}},{"label":"New Section","translations":{},"slug":"manifesto/new-section","attrs":{}},{"label":"Additional Section","translations":{},"slug":"manifesto/additional-section","attrs":{}}]},{"label":"Research Papers","translations":{},"collapsed":false,"items":[{"label":"Robotics","translations":{},"slug":"researchpapers/robotics","attrs":{}},{"label":"Uncertainty","translations":{},"slug":"researchpapers/uncertainty","attrs":{}}]},{"label":"Reference","translations":{},"collapsed":false,"autogenerate":{"directory":"reference"}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"ArtifactVirtual Docs"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///C:/_worxpace/artifactvirtual/celestial-chaos/","srcDir":"file:///C:/_worxpace/artifactvirtual/celestial-chaos/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, DEFAULT_HASH_PROPS as a, stripTrailingSlash as b, stripLeadingSlash as c, stripHtmlExtension as d, ensureHtmlExtension as e, ensureTrailingSlash as f, getCollectionPath as g, getCollection as h, getCollectionPathFromRoot as i, pickLang as j, stripLeadingAndTrailingSlashes as k, ensureLeadingSlash as l, stripExtension as m, getEntry as n, project as p, renderEntry as r, starlightConfig as s, useTranslations as u };
